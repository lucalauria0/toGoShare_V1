...
class CustomAdapter (var macchine: MutableList<ItemsViewModel>) : RecyclerView.Adapter<CustomAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            mListener.onItemClick(ItemsViewModel) // Pass the selected ItemsViewModel
        }
